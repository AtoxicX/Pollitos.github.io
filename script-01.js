...
document.addEventListener("fullscreenchange", () => {
    ...
    const colorChangeFrequency = 400; // Cambio de color cada 0.5 segundos
...
function changePlatformColors() {
    ...
    function showVictoryScreen(winner) {
        ...
        winnerImage.src = '${characterId}'; // Asumiendo que 'gif' contiene la URL de la imagen del jugador
